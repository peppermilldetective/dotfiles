-- Taken from Christian Chiarulli (@ChristianChiarulli) on GitHub.
-- https://github.com/ChristianChiarulli/LunarVim/blob/master/lua/lv-galaxyline/init.lua
-- Some modifications may be made to the original.
